...
{ 
    ...
    public class CartController : Controller
    {
        ...
        {
            var cart = _cartService.GetCartByUserId(_userManager.GetUserId(User)); //user login olan kullanıcı için oluşturulur.
            if (cart == null)
            {
                return Redirect("/");
            }
        ...
        private Payment PaymentProcess(OrderModel model) 
        {
            ...
            options.ApiKey = "sandbox-zxm6vtT3lFhy2gkQCUdU364wKsLM8U2o";
            options.SecretKey = "sandbox-mJIpyw13voqNs46UvNMabwhGqyAx1Y0z";
            ...
            foreach (var item in model.CartModel.CartItems)
            {
                ...
                basketItem.Price = ((item.Quantity * (int)item.Price)).ToString().Split(",")[0]; //100,00
